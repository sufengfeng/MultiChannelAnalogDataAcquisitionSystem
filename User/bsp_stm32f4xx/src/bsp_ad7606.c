...
/*
	...
	PE2/DCMI_D0/AD7606_OS0			---> AD7606_OS0		OS2:OS0 选择数字滤波参数
	PE3/DCMI_D1/AD7606_OS1         ---> AD7606_OS1
...
void AD7606_ISR(void)
{
	...
	// for (i = 0; i < 8; i++)
	// {
		memcpy(g_tAdcFifo.sBuf[g_tAdcFifo.usWrite],g_tAD7606.sNowAdc,8*2);
		if (++g_tAdcFifo.usWrite >= ADC_FIFO_SIZE)
		{
			g_tAdcFifo.usWrite = 0;
		}
